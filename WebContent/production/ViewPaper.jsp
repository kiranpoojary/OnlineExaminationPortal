...
%>
	...
	<form action="../EvaluateAnswersServlet" method="post">
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			...
			<a class="nav-link " style="color: white" href="studentAllResult.jsp">
				<i> </i>Back
			</a>
			...
			<div class="profile clearfix">
				...
				<div class="profile_info">
					...
					<h2>
						SRN:<%=session.getAttribute("logedID")%></h2>
				</div>
			</div>
		</div>
		</nav>
			...
			<ul class="list-group">
				<%
					...
					try {
						...
						while (mcqQuest.next()) {
							correctAns = mcqQuest.getString("choice" + mcqQuest.getString(8));
							mcqQNo++;
				...
				<h6 style="padding-top: 50px;">
					<%=mcqQNo%>).<%=mcqQuest.getString(3)%></h6>   
						<label style="color:red">Correct Answer :<%=correctAns %></label>
				...
				<li class="list-group-item">
					<div class="checkbox">
						...
						<div class="row" style="color:red">
							Maximum Marks:
							<%=descrQuest.getInt(5)%>&nbsp;&nbsp;&nbsp;&nbsp; Obtained Marks:<%=descrAns.getInt(6)%><br>
							<br>
						</div>
						Comments:
						<textarea name=""
							style="width: 550px; height: 60px" class="form-control" disabled><%=descrAns.getString(7)
							%></textarea>
