										...
										<div class="row justify-content-center">
											<div class="col-md-6">
												<div class="card">
													...
													<h4 class="card-title mt-2">Fill Student Details</h4>
													</header>
														...
														<div class="form-row">
															<div class="col form-group">
																<label>Student Full Name</label> <input type="text"
																	class="form-control" name="fName" placeholder=""
																	required>
															</div>
															<!-- form-group end.// -->
															<div class="col form-group">
																<label>Register Number</label> <input type="text"
																	class="form-control" name="regNo" required
																	placeholder=" ">
															</div>
															<!-- form-group end.// -->
														</div>
														...
														<div class="form-row">
															...
															<div class="col form-group">
																<label>Student Email ID</label> <input type="email"
																	class="form-control" name="stdEmail" placeholder=""
																	required>
															</div>
														</div>
													...
													<br>
													<label><b>Add Details Using xls or xlsx file</b></label>
													<form method="post" action="../ReadStudentExcelFile"
													...
													<div class="border-top card-body text-center">
														FAQ about Adding Students? <a href="faq.html">Click Here</a>
													</div>
												</div>
												<!-- card.// -->
											</div>
