				...
				<div class="">
					<div class="page-title">
						<div class="title_left">
							<h3>Add New Subject to Course</h3>
						</div>
										...
										<div class="row justify-content-center">
											<div class="col-md-6">
												<div class="card">
													...
													<h4 class="card-title mt-2">Subject Details</h4>
													</header>
														...
														<div class="form-row">
															<div class="col form-group">
																<label>Subject Code</label> <input type="text"
																	class="form-control" name="subCode" placeholder=""
																	required>
															</div>
															<!-- form-group end.// -->
															<div class="col form-group">
																<label>Subject Name</label> <input type="text"
																	class="form-control" name="subName" placeholder=" "
																	required>
															</div>
															<!-- form-group end.// -->
														</div>
														...
														<div class="form-row">
																	...
																	<%
																		try {
																			...
																			PreparedStatement ps = (PreparedStatement) connection.prepareStatement(
																					"SELECT semID,semName FROM coursesemister where courseID IN(SELECT courseID from courses WHERE InstuID=?)");
															...
															<div class="col form-group">
																<label>Lecturer ID</label> <select id="inputType"
																	name="subLecture" class="form-control">
																	<%
																		try {
																			String dbUrl = "jdbc:mysql://localhost/oep_db";
																			String driverName = "com.mysql.jdbc.Driver";
																			...
																			PreparedStatement ps2 = (PreparedStatement) connection
																					.prepareStatement("SELECT teacherID FROM teachers where InstuID=? ");
													...
													<label><b>Add subjects using xls or xlsx file</b></label>
													<form method="post" action="../ReadSubjectExcelFile"
														enctype='multipart/form-data'>

														<div class="form-row">
															<div class="col form-group">
																<label>Select File</label> <input type="file"
																	name="xlSheet" class="form-control"
														...
														<input type="submit" value="Upload File"
															class="btn btn-primary" name="students">
													...
													<div class="border-top card-body text-center">
														FAQ about Adding Subjects? <a href="faq.html">Click Here</a>
													</div>
												</div>
												<!-- card.// -->
											</div>
