								...
								<div class="x_content">
									...
									<table id="customers">
										...
										<%
											...
											try {
												...
												PreparedStatement ps2 = (PreparedStatement) connection.prepareStatement(
														"SELECT * FROM exams WHERE InstuID=? AND  status='Exam Ended' ORDER BY examID");
												...
												while (rs2.next()) {
													...
													PreparedStatement ps3 = (PreparedStatement) connection.prepareStatement(
															"SELECT count(examID) FROM answerdescriptive WHERE examID=? AND evalStatus=?");
													ps3.setString(1, rs2.getString(1));
													ps3.setString(2, "Not_Evaluated");
										...
										<tr>
											...
											<%
												if ("Announced".equals(rs2.getString(9))) {
											%>

											<td><a href="#" class="btn btn-info">Announced</a></td>
											...
											<td><a
												href="announceConfirm.jsp?testID=<%=rs2.getString(1)%>"
												class="btn btn-info" style="width: 143px">Announce Now</a></td>
										...
										<tr>
											<td colspan="7"><center>No Pending Result Announcement</center></td>
										</tr>
										<%
											}
