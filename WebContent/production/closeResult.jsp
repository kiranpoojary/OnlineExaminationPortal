								...
								<div class="x_content">
									...
									<table id="customers">
										...
										<%
											...
											try {
												...
												PreparedStatement ps2 = (PreparedStatement) connection.prepareStatement(
														"SELECT * FROM exams WHERE InstuID=? AND  status='Result Announced' ORDER BY examID");
										...
										<tr>
											...
											<td><a
												href="closeConfirm.jsp?testID=<%=rs2.getString(1)%>"
												class="btn btn-info" style="width: 143px">Close Result</a></td>
										...
										<tr>
											<td colspan="7"><center>No Active Results Announcements</center></td>
										</tr>
										<%
											}
