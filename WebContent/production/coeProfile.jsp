...
<div class="right_col" role="main">
						...
						<div class="col-md-12 col-sm-12  ">
							<div class="x_panel">
								<div class="container emp-profile">
									<form action="../UpdateCOEProfileServlet" method="post"
										...
										<div class="row">
											<div class="col-md-4">
												<div class="profile-img">
													...
													<div class="file btn btn-lg btn-primary">
														Change Photo <input type="file" name="pictureFile"  required/>
													</div>
												</div>
											</div>
											...
											<div class="col-md-6">
												<div class="profile-head">
													<h5>
														COE of <%=session.getAttribute("instuName")%>
													</h5>
													
													<p class="proile-rating">
														Email ID. : <span> <%=session.getAttribute("logedID")%></span>
													</p>
	...
	<div class="pull-right">
		Online Examination Portal - 2020<a href="#">About Us</a>
	</div>
	<div class="clearfix"></div>
	</footer>
	<!-- /footer content -->
