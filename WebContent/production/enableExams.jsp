	...
	<div class="container body">
		<div class="main_container">
					...
					<div id="sidebar-menu"
						...
						<div class="menu_section">
							...
							<ul class="nav side-menu">
								...
								<li><a><i class="fa fa-bar-chart-o"></i>Result Charts<span
										class="fa fa-chevron-down"></span></a>
									<ul class="nav child_menu">
										<li><a href="chartSelectTest.jsp">Select Test</a></li>
								...
								<div class="x_content">
									...
									<table id="customers">
										...
										<%
											...
											try {
												...
												PreparedStatement ps2 = (PreparedStatement) connection.prepareStatement(
														"SELECT * FROM exams WHERE InstuID=? AND date=? AND status='Enabled' OR status='Finished' ORDER BY examTime ASC");
										...
										<tr>
											...
											<%
												if ("Enabled".equals(rs2.getString(9))) {
													
											%>

											<td><a
												href="confirmEndExam.jsp?testID=<%=rs2.getString(1)%>"
												class="btn btn-info" style="width: 143px">End Exam</a></td>

											<%
												} else {
															if ("Finished".equals(rs2.getString(9))) {
											%>

											<td><a
												href="confirmEnableExam.jsp?testID=<%=rs2.getString(1)%>"
												class="btn btn-info" style="width: 143px">Enable Exam</a></td>
											...
											<td><a href="#" class="btn btn-info"
												style="width: 143px">Can't Enable</a></td>
										...
										<tr>
											<td colspan="7"><center>No Exams Scheduled
													Today</center></td>
										</tr>
										<%
											}
			...
			<div class="pull-right">
				Online Examination Portal<%=today%>
