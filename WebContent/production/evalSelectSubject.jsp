							...
							<ul class="nav side-menu">
								...
								<li><a><i class="fa fa-sitemap"></i> Exam Evaluation <span
									...
									<ul class="nav child_menu">
										...
										<li><a>Start Evaluation<span
												class="fa fa-chevron-down"></span></a>
											<ul class="nav child_menu">
												<li class="sub_menu"><a href="evalSelectSubject.jsp"><b>Select
															Subject</b></a></li>
								...
								<div class="x_content">
									...
									<table id="customers">
										...
										<%
											try {
												...
												PreparedStatement ps2 = (PreparedStatement) connection.prepareStatement(
														"SELECT * FROM exams LEFT JOIN subjects ON exams.subjectID=subjects.subjectID WHERE subjects.teacherID=? AND status='Exam Ended'");
												ps2.setString(1, session.getAttribute("logedID").toString());
										...
										<tr>
											...
											<td><a
												href="selectStudentPaper.jsp?testID=<%=rs2.getString(1)%>"
												class="btn btn-info">Evaluate</a></td>
										</tr>
										<%
											}
												if (rec == 0) {
										%>
										<tr>
											<td colspan="6"><center>No Pending Test Evaluation</center></td>
										</tr>
										<%
											}
