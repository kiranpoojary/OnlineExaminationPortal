		...
		<div class="main_container">
			<div class="col-md-3 left_col">
				<div class="left_col scroll-view">
					...
					<%
					request.setAttribute("pic", session.getAttribute("pic"));
					%>
					...
					<div class="sidebar-footer hidden-small">
						<a data-toggle="tooltip" data-placement="top" title="Settings">
							...
							href="../LoginStudent.jsp"> <span class="glyphicon glyphicon-off"
				...
				<div class="nav_menu">
					...
					<ul class=" navbar-right">
						<li class="nav-item dropdown open" style="padding-left: 15px;">
							...
							aria-expanded="false"> <img src="data:image/jpeg;base64,${pic}" alt=""><%=session.getAttribute("stdName")%>
						</a>
							<div class="dropdown-menu dropdown-usermenu pull-right"
								aria-labelledby="navbarDropdown">
								<a class="dropdown-item" href="../production/profile.jsp"> Profile</a> <a
									class="dropdown-item" href="javascript:;"> <span
									class="badge bg-red pull-right">50%</span> <span>Settings</span>
								</a> <a class="dropdown-item" href="javascript:;">Help</a> <a
									class="dropdown-item" href="../LoginStudent.jsp"><i
									...
									<table id="customers">
										...
										<%
											try {
												...
												PreparedStatement ps = (PreparedStatement) connection.prepareStatement("SELECT instuID,courseSemID,fullName from students where studentReg=?");
												ps.setString(1, session.getAttribute("logedID").toString());
												...
												if(rs.next())
												{
													...
													session.setAttribute("stdCourseID",co);
													session.setAttribute("stdFullName",fn);
													
												}
												
												String query="SELECT * from exams e where e.InstuID=? AND status!=? AND subjectID IN(select s.subjectID from subjects s,exams e WHERE s.semID=? AND e.subjectID=s.subjectID)";
												PreparedStatement ps2 = (PreparedStatement) connection.prepareStatement(query);
												ps2.setString(1, IID);
												ps2.setString(2, "Result Closed");
												ps2.setString(3, co);
										...
										%>
										<tr>
											<td colspan="7"><center>No Exams Scheduled</center></td>
										</tr>
										<%
											}
