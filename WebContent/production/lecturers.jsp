						...
						<div class="menu_section">
							...
							<ul class="nav side-menu">
								...
								<li><a><i class="fa fa-edit"></i> Upload Questions <span
										class="fa fa-chevron-down"></span></a>
									<ul class="nav child_menu">
										<li><a href="uploadSelectSubject.jsp">Select Test</a></li>
				...
				<div class="">
					...
					<div class="row">
						<div class="col-md-12 col-sm-12  ">
							<div class="x_panel">
								<div class="x_title">
									<h2>All Your Upcomming Exams</h2>
								...
								<div class="x_content">
									...
									<table id="customers">
										...
										<%
											try {
												...
												PreparedStatement ps2 = (PreparedStatement) connection.prepareStatement(
														"SELECT * FROM exams LEFT JOIN subjects ON exams.subjectID=subjects.subjectID WHERE subjects.teacherID=? AND status!='Result Closed'");
										...
										%>
										<tr>
											<td colspan="6"><center>No Exams Scheduled</center></td>
										</tr>
										<%
											}
