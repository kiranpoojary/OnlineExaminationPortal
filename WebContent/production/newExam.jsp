...
%>
	<div class="container body">
										...
										<div class="row justify-content-center">
											<div class="col-md-6">
												<div class="card">
													...
													<h4 class="card-title mt-2">Fill Exam Details</h4>
													</header>
													<article class="card-body">
													<form action="../NewExamServlet" method="post">

														<div class="form-row">
															<div class="col form-group">
																<label>Test Name</label> <input type="text"
																	class="form-control" name="testName" required> </select>
															</div>
															<!-- form-group end.// -->
															<div class="col form-group">
																<label>Subject Code</label> <select name="subjectCode"
																	id="inputType" class="form-control">
																	<%
																		try {
																			...
																			PreparedStatement ps2 = (PreparedStatement) connection
																					.prepareStatement("SELECT subjectID from subjects WHERE semID IN(SELECT semID from courses where instuID=?)");
														...
														<div class="form-row">
															<div class="col form-group">
																<label>Exam Date</label> <input type="date"
																	...
																	value="<%=LocalDate.now().plusDays(0).toString()%>"
																	min="<%=LocalDate.now().plusDays(0).toString()%>"
																	placeholder="">
															...
															<!-- form-group end.// -->
															<div class="col form-group">
																<label>Exam Time</label> <input type="time"
																	class="form-control" name="examTime" placeholder=" "
																	required>
															</div>
															<!-- form-group end.// -->
														</div>
														...
														<div class="form-row">
															<div class="col form-group">
																<label>Total Duration in Minutes</label> <input
																	type="number" class="form-control" name="duration"
																	value=30 min=30 step=5 placeholder="">
															</div>
															<!-- form-group end.// -->
															<div class="col form-group">
																<label>Max Marks</label> <input type="number"
																	class="form-control" value="5" min="5" name="marks" step=5
																	placeholder=" ">
															</div>
															<!-- form-group end.// -->
														</div>
												...
												<div class="border-top card-body text-center">
													FAQ about Schedule Exams? <a href="">Click Here</a>
												</div>
											</div>
											<!-- card.// -->
										</div>
		...
		<div class="pull-right">
			Online Examination Portal <a href="https://colorlib.com">,(c) all
				rights reserved-2020</a>
		</div>
		<div class="clearfix"></div>
		</footer>
		<!-- /footer content -->
