					...
					<div id="sidebar-menu"
						...
						<div class="menu_section">
							...
							<ul class="nav side-menu">
								...
								<li><a><i class="fa fa-sitemap"></i> Data Table<span
										class="fa fa-chevron-down"></span></a>
									<ul class="nav child_menu">

										<li><a>Result Tables<span class="fa fa-chevron"></span></a>
											<ul class="nav child_menu">

												<li><a href="allTestResult.jsp">Select Test<span
														class="fa fa-chevron"></span></a>
													<ul class="nav child_menu">
														<li class="sub_menu"><a href="oneTestResult.jsp"><b>Test
																	Result</b></a></li>
													</ul></li>
											</ul></li>
