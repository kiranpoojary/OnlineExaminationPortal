						...
						<div class="menu_section">
							...
							<ul class="nav side-menu">
								...
								<li><a><i class="fa fa-edit"></i> Upload Questions <span
										class="fa fa-chevron-down"></span></a>
									<ul class="nav child_menu">
										<li><a href="uploadSelectSubject.jsp">Select To
												Upload</a></li>
								...
								<li><a><i class="fa fa-sitemap"></i> Exam Evaluation <span
										class="fa fa-chevron-down"></span></a>
									<ul class="nav child_menu">
										<li><a>Start Evaluation<span class="fa fa-chevron"></span></a>
											<ul class="nav child_menu">

												<li><a href="evalSelectSubject.jsp">Select Subject<span
														class="fa fa-chevron"></span></a>
													<ul class="nav child_menu">
														<li class="sub_menu"><a href="selectStudentPaper.jsp"><b>Select
																	Paper</b></a></li>
					...
					<ul class=" navbar-right">
						<li class="nav-item dropdown open" style="padding-left: 15px;">
							...
							aria-expanded="false"> <img
								src="data:image/jpeg;base64,${pic}" alt=""><%=session.getAttribute("teacherName")%>
						</a>
								...
								<div class="x_content">
									...
									<table id="customers">
										...
										<%
											try {
												...
												PreparedStatement ps2 = (PreparedStatement) connection.prepareStatement(
														"SELECT * FROM exams LEFT JOIN answerdescriptive ON exams.examID=answerdescriptive.examID WHERE exams.examID=? GROUP BY studID");
												ps2.setString(1, request.getParameter("testID").toString());
										...
										<tr>
											...
											<%
												if (rs2.getString(17).equals("Not_Evaluated")) {
											%>
											<td><a
												href="evaluateTestPage.jsp?testID=<%=rs2.getString(1)%>&studID=<%=rs2.getString(10)%>"
												class="btn btn-info">SELECT</a></td>

											<%
												} else {
											%>
											<td><a href="#" class="btn btn-info">Evaluated</a></td>
										...
										<tr>
											<td colspan="6"><center>No Answer Papers Found</center></td>
										</tr>
										<%
											}
