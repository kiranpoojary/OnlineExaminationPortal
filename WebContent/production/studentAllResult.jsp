				...
				<div class="">
					<div class="page-title">
						<div class="title_left">
							<h3>Your Recent Test Score Card</h3>
						</div>
								...
								<div class="x_content">
									<table id="customers">
										<tr>
											...
											<th>Score</th>
											<th>Attended</th>
											<th>Class Result Chart And Paper</th>
										</tr>
										...
										<%
											...
											try {
												...
												PreparedStatement ps3 = (PreparedStatement) connection.prepareStatement(
														"SELECT examID,totMarks,subjectID FROM exams WHERE examID IN(SELECT examID FROM exams e,coursesemister c,subjects sub,students st WHERE st.courseSemID=c.semId AND st.studentReg=? AND c.semID=sub.semID AND e.status='Result Announced')");
												ps3.setString(1, session.getAttribute("logedID").toString());
												...
												while (rs3.next()) {
													...
													ps4.setString(5, session.getAttribute("logedID").toString());
													...
													if (rs4.next()) {
														...
														if (score == 0) {
															...
															ps5.setString(2, session.getAttribute("logedID").toString());
															ps5.setString(3, rs3.getString(1));
															ps5.setString(4, session.getAttribute("logedID").toString());
										...
										<tr>
											...
											%>
											<td><a
												href="../TestBarChart?testID=<%=rs3.getString(1)%>"
												class="btn btn-info">View Result Chart</a><a
												href="ViewPaper.jsp?testID=<%=rs3.getString(1)%>&studID=<%=session.getAttribute("logedID").toString() %>"
												class="btn btn-info">View Paper</a></td>
												<%
											}
												%>
										</tr>
										...
										%>
										<tr>
											<td colspan="6"><center>No Results Available</center></td>
										</tr>
										<%
											}else
												%>
												<tr>
												<td colspan="6"><a href="scoreCard.jsp" class="btn btn-success">Score Card</a></td>
												</tr>
												<%
