									...
									String studID=request.getParameter("studID");
									 ...
									 Blob blob=null;
										...
										try {
											...
											ps2.setString(1, "100112UE17MC101ISA1");
											ps2.setString(2, "PES12018101");
											...
											//Thread.sleep(50000);
											//response.sendRedirect("../production/evaluateTestPage.jsp?testID="+ testID+"&studID="+studID);										
											//System.out.println("../production/evaluateTestPage.jsp?testID="+testID+" "+studID);
									%>
