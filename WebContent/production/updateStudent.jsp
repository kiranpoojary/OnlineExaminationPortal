...
%>
	<div class="container body">
		<div class="main_container">
			...
			<!-- page content -->
			<%
			if(request.getParameter("op").toString().equals("update"))
			{
			%>
										...
										<div class="row justify-content-center">
											<div class="col-md-6">
												<div class="card">
													...
													<h4 class="card-title mt-2">Update Student Details</h4>
													</header>
														...
														<div class="form-row">
															<div class="col form-group">
																<label>Student Full Name</label> <input type="text"
																	class="form-control" name="fName" value=<%=request.getParameter("studName") %> placeholder="">
															</div>
															<!-- form-group end.// -->
															<div class="col form-group">
																<label>Register Number</label> <input type="text"
																	class="form-control" name="regNo"  value=<%=request.getParameter("studID") %> placeholder=" ">
															</div>
															<!-- form-group end.// -->
														</div>
														<div class="form-row">
															<div class="col form-group">
																<label>Current Course:- <%=request.getParameter("studCourse") %>
																<%
																session.setAttribute("oldReg",request.getParameter("studID").toString());
																%>
																</label> <select id="inputType"
																	...
																	<%
																		try {
																			...
																			PreparedStatement ps = (PreparedStatement) connection
																					.prepareStatement("select * from coursesemister cs,courses c WHERE cs.courseId=c.courseID AND c.InstuID=?");
																			ps.setString(1, session.getAttribute("instuID").toString());
															...
															<div class="col form-group">
																<label>Student Email ID</label> <input type="email"
																	class="form-control" name="stdEmail" value=<%=request.getParameter("studEmail") %> placeholder="">
															</div>
														</div>
													...
													<div class="border-top card-body text-center">
														FAQ about Adding Students? <a href="">Click Here</a>
													</div>
												</div>
												<!-- card.// -->
											</div>
			...
			{
				if(request.getParameter("op").toString().equals("delete"))
				{
					...
					try {
						...
						Connection connection = DriverManager.getConnection(dbUrl, "root", "");
						PreparedStatement ps = (PreparedStatement) connection
								.prepareStatement("DELETE FROM students where InstuID=? and studentReg=?");
						ps.setInt(1,Integer.parseInt(request.getParameter("instuID").toString()));
						ps.setString(2, request.getParameter("studID").toString());
						int deleted = ps.executeUpdate();
						if(deleted>0)
						{
							%>
							<script type="text/javascript">alert('Record Deleted Successfuly');
							window.location="promoteStudent.jsp";
							</script>
							<%
						...
						%>
						<script type="text/javascript">alert('Something Went Wrong');
						window.location="promoteStudent.jsp";</script>
						<%
