				...
				<div class="">
					<div class="page-title">
						<div class="title_left">
							<h3>All Question Upload status</h3>
						</div>
											...
											<%
												...
												try {
													...
													PreparedStatement ps2 = (PreparedStatement) connection
															.prepareStatement("SELECT * FROM exams WHERE instuID=? AND status!='Ended' ORDER BY date ASC ");
											...
											<tr>
												...
												<%
													PreparedStatement ps6 = (PreparedStatement) connection.prepareStatement(
															...
															ps6.setString(2, rs2.getString(1));
...
<!-- 
												<td><%=status%> <% if(status.equals("Scheduled,No questions Uploaded")||status.equals("Uploa pending")){%><input type="button" value="Remind" class="btn btn-primary"><%} %></td>
 ...
 -->
											...
											%>
											<tr>
												<td colspan="8"><center>No Exams Found </center></td>
											</tr>
											<%
												}
