...
/**
 * Servlet implementation class DescriptiveUploadServlet
 */
@WebServlet("/DescriptiveUploadServlet")
public class DescriptiveUploadServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DescriptiveUploadServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String descriptiveQ=request.getParameter("descriptiveQ");
		String descriptiveAns=request.getParameter("descriptiveAns");
		int descriptiveMarks=Integer.parseInt(request.getParameter("descriptiveMark"));
...
;
		...
		if((uploadedMarks+descriptiveMarks)>maxMarks)
		{
			out.print("<script>");
		...
		{
			if(upload.uploadDescriptive(testID, descriptiveQ, descriptiveAns, descriptiveMarks,"Descriptive"))
			{
				out.print("<script>");
		...
		//System.out.println(descriptiveAns+descriptiveQ+descriptiveMarks);
